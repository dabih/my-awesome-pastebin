...
run-audit-all:
	@echo "Running audit for all services..."
	make -C backend/admin_panel run-audit
	make -C backend/web_api run-audit
	make -C backend/kafka_consumer run-audit
	@echo "Audit completed for all services."
